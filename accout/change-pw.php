<?php
	...
	$result_thanhvien=mysqli_query($con,"SELECT * FROM thanhvien where user='$idkey'");
	...
	if(isset($_POST["act"])){	
		...
		$result_thanhvien2=mysqli_query($con,$sql);
		...
		else
		{
			...
			{
				$pw=md5($pw);	
				$result_changepw = mysqli_query($con,"UPDATE thanhvien SET pass='$pww' WHERE user='$user'");
